	...
	def read_csv(self):
		...
		with open(file_name, "rb") as f:
			for line in f:
				...
				line=str(line)
				line=line.strip()
				if "property,unit,address,price,bed,bath,description,accessinstructions,occupancy,availability" in line:
			...
			field_names=['property','unit','address','price','bed','bath','description','accessinstructions','occupancy','availability','empty_val']
